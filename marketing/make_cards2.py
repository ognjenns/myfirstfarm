...
OUT = "/private/tmp/claude-501/-Users-manevskiognjen-svasta/aff2515b-1833-484a-af07-bd79415d0284/scratchpad/cards2"
...
CARDS = [
    ("03-tri-sveta.png", "There is no way\nto lose this game.", "That is the whole point."),
    ("02-farma.png",     "Farm",              "Feed them. Wash them. Find them."),
    ("04-dzungla.png",   "Jungle",            "Listen. Match. Guess."),
    ("01-okean.png",     "Ocean",             "Bubbles, reefs, a tiny orchestra."),
    ("06-boje.png",      "No text to read",   "They cannot read yet.\nThey do not need to."),
    ("07-ribica.png",    "No timers",         "Nothing counts down. Nothing rushes."),
    ("08-za-roditelje.png", "No ads",         "Nothing interrupts.\nNothing asks for money."),
    ("05-orkestar.png",  "Twelve games",      "Three worlds that keep growing."),
    (None,               "My First Animals",  ""),
]
