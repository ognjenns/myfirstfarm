...
class GodotIapExportPlugin extends EditorExportPlugin:
	...
	# NAŠA IZMENA: Android billing radi preko GodotGooglePlayBilling — ovaj
	# addon koristimo SAMO za iOS (StoreKit). Android delovi su uklonjeni da
	# ne bi u gradle build ubacili drugu Play Billing biblioteku (sudar klasa).
